 ...
 */
class Bluehorse_Storelocator_Helper_Data extends Mage_Core_Helper_Abstract
{
    /**
     ...
     * @var string
     */
    const XML_PATH_ENABLED = 'bluehorse_storelocator_general_setting/bluehorse_storelocator_status/enable';
     ...
     * @var string
     */
    const XML_PATH_DEFAULT_RADIUS = 'bluehorse_storelocator_general_setting/bluehorse_storelocator_display_setting/default_radius';
     ...
     * @var string
     */
    const XML_PATH_DEFAULT_ZOOM_LEVEl = 'bluehorse_storelocator_general_setting/bluehorse_storelocator_display_setting/zoom_level';
     ...
     * @var string
     */
    const XML_PATH_STORES_PER_PAGE = 'bluehorse_storelocator_general_setting/bluehorse_storelocator_display_setting/stores_per_page';
