 ...
 */
class Bluehorse_Storelocator_Helper_Image extends Mage_Core_Helper_Abstract
{
    /**
     ...
     * @var string
     */
    const MEDIA_PATH    = 'bluehorse_storelocator';
    ...
    public function uploadImage($scope)
    {
        ...
        if ($adapter->isUploaded($scope)) {
            ...
            if (!$adapter->isValid($scope)) {
                Mage::throwException(Mage::helper('bluehorse_storelocator')->__('Uploaded image is not valid'));
            }
     ...
     *
     * @param Bluehorse_Storelocator_Model_View $store
     * @param integer $width
     * @param integer $height
     * @return bool|string
     */
    public function resize(Bluehorse_Storelocator_Model_Storelocator $store, $width, $height = null)
    {
