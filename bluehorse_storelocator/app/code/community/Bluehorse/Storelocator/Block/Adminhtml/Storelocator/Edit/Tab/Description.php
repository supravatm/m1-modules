...
class Bluehorse_Storelocator_Block_Adminhtml_Storelocator_Edit_Tab_Description extends Mage_Adminhtml_Block_Widget_Form
{
    /**
    ...
    protected function _prepareForm()
    {
        ...
        $this->setForm($form);
        $fieldset = $form->addFieldset('form_General', array('legend'=>Mage::helper('bluehorse_storelocator')->__('Description')));
