 ...
 */
class Bh_Events_Block_Adminhtml_Details_Edit_Tab_Image extends Mage_Adminhtml_Block_Widget {
    ...
    protected function _prepareLayout() {
        ...
        $this->setChild("uploader", $this->getLayout()->createBlock("events/adminhtml_media_uploader"));
    ...
    public function getImagesJson() {
        ...
        $_model = Mage::registry('details_data');
		$events_details_id=$_model->getData('events_details_id');
		$_data = Mage::getModel('events/images')->getCollection()->addFieldToFilter('cat_id', array('eq' => $events_details_id));
        if (sizeof($_data) > 0) {
            ...
            foreach ($_data as $_item) {
                ...
                $_result[] = array(
                    ...
                    'file'      => $_item['file'],
					'label'      => Mage::getSingleton('events/config')->getBaseMediaUrl() . $_item['file'],
